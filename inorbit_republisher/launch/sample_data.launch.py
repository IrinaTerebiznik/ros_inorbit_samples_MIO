...
def generate_launch_description():
    return LaunchDescription([
        # Declarar el argumento 'config_file' con su valor por defecto
        DeclareLaunchArgument(
            'config_file',
            default_value='/root/ros2_ws/src/inorbit_republisher/test/sample_data/config/example.yaml',
            description='Ruta al archivo de configuración del republisher'
        ),
